// ACTION TYPES
export const Types = {
  SET_LIST: "exams/SET_LIST",
  SET_SELECTED: "exams/SET_SELECTED",
  SET_NEW_LOADING: "exams/SET_NEW_LOADING",
  SET_EDIT_LOADING: "exams/SET_EDIT_LOADING",
  SET_DELETE_LOADING: "exams/SET_DELETE_LOADING",
};
